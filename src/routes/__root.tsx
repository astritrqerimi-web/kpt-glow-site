...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "KPT Consulting — Kontabilitet, Program, Trajnime" },
      { name: "twitter:description", content: "Shërbime profesionale të kontabilitetit, deklarimeve tatimore, regjistrimit të bizneseve dhe konsulencës financiare në Kosovë." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/64ccb311-1b6d-4fb6-bc2e-40aeddb29b2d" },
    ...
    links: [
      ...
      { rel: "icon", href: "/kpt-favicon-v3.ico?v=3", sizes: "any" },
      { rel: "shortcut icon", href: "/kpt-favicon-v3.ico?v=3" },
      { rel: "icon", type: "image/svg+xml", href: "/kpt-favicon-v3.svg?v=3" },
      { rel: "icon", type: "image/png", sizes: "16x16", href: "/kpt-favicon-v3-16.png?v=3" },
      { rel: "icon", type: "image/png", sizes: "32x32", href: "/kpt-favicon-v3-32.png?v=3" },
      { rel: "icon", type: "image/png", sizes: "48x48", href: "/kpt-favicon-v3-48.png?v=3" },
      { rel: "icon", type: "image/png", sizes: "96x96", href: "/kpt-favicon-v3-96.png?v=3" },
      { rel: "apple-touch-icon", sizes: "180x180", href: "/kpt-favicon-v3-180.png?v=3" },
