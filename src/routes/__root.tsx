...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "shortcut icon", href: "/favicon-v6.ico" },
      { rel: "icon", type: "image/png", sizes: "16x16", href: "/kpt-favicon-v6-tab-16.png" },
      { rel: "icon", type: "image/png", sizes: "32x32", href: "/kpt-favicon-v6-tab-32.png" },
      { rel: "icon", type: "image/png", sizes: "48x48", href: "/kpt-favicon-v6-48.png" },
      { rel: "icon", type: "image/png", sizes: "96x96", href: "/kpt-favicon-v6-96.png" },
